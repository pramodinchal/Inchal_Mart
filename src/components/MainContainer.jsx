  ...
  return (
    <div className='w-full h-auto flex flex-col items-center justify-center'>
      ...
      <div className='w-full flex items-center justify-between'>
        ...
        <div className='hidden medium:flex gap-3 items-center'>
          <motion.div 
          whileTap={{ scale: 0.75}}
          className='w-8 h-8 rounded-lg bg-orange-300 hover:bg-orange-500 cursor-pointer tansition-all duration-100 ease-in-out hover:shadow-lg flex items-center justify-center'>
