          ...
          <div className="relative">
               ...
               className="w-36 bg-gray-50 shadow-xl rounded-lg flex flex-col absolute top-12 right-0 ">
           {
            user && user.email === "inchalpramod@gmail.com" && (
             <Link to={'./createitem'}>
             <p className="px-2 py-2 flex items-center gap-3 cursor-pointer hover:bg-slate-100 transition-all duration-100 ease-in-out" onClick={() => setIsMenu(false)}>Add Item<MdOutlineAdd style={{display: "inline",marginLeft: "15px"}} /></p>
             </Link>
            )
           }
